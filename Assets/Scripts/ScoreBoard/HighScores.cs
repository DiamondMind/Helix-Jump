...
{
    const string privateCode = "0IHxtsQ6Jk6D9AauqvnOBgyvz7YFKWuUmNgY9Twk_fcQ";  //Key to Upload New Info
    const string publicCode = "6533103d8f40bb11fc4e1c1d";   //Key to download
